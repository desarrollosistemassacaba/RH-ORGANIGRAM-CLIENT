...
import { convertToDecimal } from "src/app/utils/utils";
...
export class DialogNivelComponent {
  ...
  guardar() {
    this.clearCampos();
    convertToDecimal(this.FormNivel, "nombre");
    convertToDecimal(this.FormNivel, "haber_basico");
    convertToDecimal(this.FormNivel, "cns");
    convertToDecimal(this.FormNivel, "solidario");
    convertToDecimal(this.FormNivel, "provivienda");
    convertToDecimal(this.FormNivel, "profesional");
